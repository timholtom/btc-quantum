...
- Nobel physicist John Martinis interview (CoinDesk, Apr 7, 2026): 2025 Nobel Prize winner and former Google quantum hardware leader (led 2019 "quantum supremacy" experiment) warns Bitcoin is "low-hanging fruit" for quantum computers. Breaking cryptography is "one of the easier applications" because it's "very numeric" with "smaller, easier algorithms." Gives 5-10 year window for CRQCs. Highlights transaction broadcast vulnerability window where public keys are exposed before block confirmation. Now CTO of Qolab building utility-scale superconducting quantum computers. Warns: "The crypto community has to plan for this. It's a serious issue."
- Fortune "freeze Satoshi's wallets" debate (Apr 6, 2026): Growing debate over whether Bitcoin should force compulsory quantum-resistant upgrade that would lock Satoshi's ~1.1M BTC (~$75B) forever. Exodus CEO JP Richardson warns coins on old addresses "could eventually be taken by whoever first has practical quantum capacity" but opposes forced upgrades. Bitcoin historian Pete Rizzo reveals Satoshi Roundtable (Feb 2026) heard calls to make BIP-360 mandatory — position he says reflects speculators concerned with valuation, not Bitcoin values. Both agree compulsory upgrade would never achieve developer consensus. Crystallizes Bitcoin's core tension: protecting network value vs. self-sovereignty. 6.9M BTC total in quantum-vulnerable addresses. Fortune frames as "asking the unthinkable."
- Bitcoin dev pushback on rushing quantum fixes (Bitbo, Apr 7, 2026): Growing counter-movement. Samson Mow (JAN3): "Solving the QC problem later rather than sooner is the best course of action" — warns hasty ECDSA/Schnorr replacements could introduce classical vulnerabilities, PQ signature bloat could reignite Blocksize Wars debates, and some PQ schemes may contain backdoors (referencing Snowden disclosures on RNG). Adam Back (Blockstream): insufficiently reviewed PQ implementations could introduce security flaws before QC is a real threat; favors conservative hash-based SPHINCS+. Jonas Schnelli: PQ signatures significantly larger than Schnorr, far less real-world testing — "The cure, rushed, could be worse than the disease." Consensus: changes need extensive review; practical quantum risks years away. BIP-360 referenced as optional, measured approach.
- BTC Policy Institute "State of Play" (Apr 10, 2026): Comprehensive policy analysis synthesizing Google QAI paper (500K qubits, 20x reduction) and Caltech/Oratomic paper (10K-26K qubits). Key finding: "resource requirements for quantum attack on Bitcoin's cryptography are coming down faster than most experts expected." Reports BIP-360 testnet has 50+ miners, 100K+ blocks, 100+ cryptographer contributors. Notes Taproot already has architectural scaffolding for quantum resistance via hidden fallback spending conditions. Places Bitcoin in policy context: NIST gives feds until 2035, Google targets 2029 internally, EO 14144 (Jan 2025) embedded PQ deadlines in federal cybersecurity. Bitcoin's challenge: no CEO to mandate upgrades — consensus must be earned. Notes Bitcoin has done this before: SegWit (2017), Taproot (2021). Unlike previous upgrade debates about Bitcoin's identity, quantum security aligns all participants' incentives.
- CoinDesk "$1.3 Trillion Security Race" (Apr 4-5, 2026): Comprehensive technical breakdown of all major quantum-proofing initiatives. Covers: BIP-360/P2MR (removes on-chain public key), SPHINCS+/SLH-DSA (hash-based PQ sigs standardized as FIPS 205, but 8KB+ vs current 64B Schnorr), new proposals SHRIMPS and SHRINCS (aim to shrink PQ sig sizes while retaining SPHINCS+ security guarantees), Tadge Dryja's commit/reveal soft fork (two-phase transactions: first publish sealed hash "alibi" on-chain, then broadcast transaction — quantum forged tx rejected because it lacks prior commitment), Hunter Beast's Hourglass V2 (gradually restricts ~1.7M BTC in exposed legacy addresses). Notes Google research shows quantum computer could crack BTC cryptography in under 9 minutes — faster than average block time. Mempool exposure: public key + signature visible while transactions await confirmation, giving quantum attacker a brief window. About 6.5M BTC ($100s of billions) in directly targetable addresses.
- BIP-361 freeze proposal (Apr 15, 2026): Jameson Lopp and five other developers propose BIP-361 to phase out quantum-vulnerable address types on a 5-year timeline. Any coins that fail to migrate would be frozen. Creates the "Satoshi problem" — dormant holders (including Satoshi's ~1.1M BTC) must wake up or lose access.
- Paradigm PACTs proposal (May 1, 2026): Dan Robinson (Paradigm GP) publishes Provable Address-Control Timestamps (PACTs) — a free, private way for holders to prove they control quantum-vulnerable wallets before quantum computers arrive. Uses BIP-322 message signing + OpenTimestamps to create a secret commitment. Later redeemable via STARK zero-knowledge proofs (quantum-safe). Addresses the "Satoshi problem" from BIP-361: holders can prove ownership without publicly moving coins. Requires a future STARK verification soft fork. Pre-BIP-32 wallets (including most Satoshi addresses) need separate rescue path. Cost is negligible. Robinson: "The cost of creating one is low enough to justify acting once a standard format is agreed upon."
- Postquant Labs quantum-safe wallet (May 2026): Launches Bitcoin wallet using Arch Network for post-quantum signature verification off-chain while settling on Bitcoin's base layer. No fork required. Part of the "don't wait for consensus" movement alongside StarkWare QSB and Lightning Labs escape hatch.
- MARA Holdings quantum defense foundation (Apr 28, 2026): Marathon Digital (~$6B market cap, 47K+ BTC) establishes dedicated foundation for Bitcoin quantum defense and network resilience. First major miner to commit dedicated resources. Miners have the most concentrated economic stake in network security.
- Galaxy Digital consensus note (May 3, 2026): Research Director Alex Thorn observes Bitcoin community is moving toward consensus on quantum threat response. Synthesizes BIP-361, PACTs, and the "don't wait" movement. Debate has shifted from "is quantum real?" to "how do we transition?" Prediction markets price quantum-resistant BTC upgrade in 2026 at 32% YES.
- Coinbase CEO Armstrong quantum coalition (Apr 2026): Armstrong announces he will personally lead an industry coalition (Block, TBD, Core contributors) to accelerate Bitcoin's post-quantum transition. Plans quantum-proof custody services for institutional clients by late 2026.
- Project Eleven Q-Day Prize (Apr 24, 2026): Awards 1 BTC bounty to researcher Giancarlo Lelli for breaking a 15-bit ECC key on public quantum hardware — 512x jump from previous 6-bit record. A solo researcher on cloud hardware, not a national lab.
